...
- [x] RSS/Atom 파싱 엔진 구현 (lib/rss-parser.js)
- [x] Chrome Storage 관리 헬퍼 (lib/storage-helper.js)
- [x] 피드 구독 관리 (추가/삭제) - 완전 구현
- [x] 15분마다 자동 동기화 (chrome.alarms) - 완전 구현
- [x] 툴바 팝업으로 글 목록 표시 - 완전 구현
- [x] 읽음/안읽음 상태 관리 - 완전 구현
- [x] 검색 및 필터링 (제목, 도메인) - 완전 구현
- [x] 카테고리 태그 시스템 - 완전 구현
- [x] 배지 알림 (읽지 않은 글 개수) - 구현됨
- [x] 기본 피드 제공 (설치 시) - 구현됨
- [x] 낚시성 콘텐츠 점수 계산 - 구현됨
